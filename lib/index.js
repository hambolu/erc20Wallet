...
let txutils = require('/lib/txutils');
let encryption = require('/lib/encryption.js');
let signing = require('/lib/signing.js');
let keystore = require('/lib/keystore.js');
let upgrade = require('/lib/upgrade.js');
...
module.exports = {
    ...
    keystore: null,
    keystoreJson: null,
    provider: 'https://mainnet.infura.io/v3/e8b04dee69d042e599bb1a30e61e02f4',
    ...
    createSeed: async function() {
        return new Promise(async(resolve, reject) => {
            try {
                resolve(await keystore.generateRandomSeed(this.mySeed));
            } catch (e) {
    ...
    decodeJson: async function() {
        return new Promise(async(resolve, reject) => {
            try {
                resolve(await keystore.deserialize(this.keystoreJson));
            } catch (e) {
